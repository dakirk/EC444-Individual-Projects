...
#define DRIVE_MAX_PULSEWIDTH 1500 //Maximum pulse width in microsecond
...
static void mcpwm_example_gpio_initialize(void)
{
    ...
    mcpwm_gpio_init(MCPWM_UNIT_0, MCPWM0A, 18);    //Set GPIO 18 as PWM0A, to which drive wheels are connected
